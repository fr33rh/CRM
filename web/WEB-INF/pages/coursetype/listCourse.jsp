...
<table width="97%" border="1" >
  ...
  <%--数据展示，单行：tabtd1；双行：tabtd2 --%>
	...
	<s:iterator value="#allCourseType" var="item" >
   <tr class="tabtd1">
	    <td align="center"><s:property value="#item.courseName" /> </td>
	    <td align="center"> <s:property value="#item.remark" /></td>
	    <td align="center"> <s:property value="#item.total" /></td>
	    <td align="center"> <s:property value="#item.courseCost" /></td>
